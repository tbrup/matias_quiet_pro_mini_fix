...
keyboard.keymap = [
    ...
    KC.F1, KC.GRAVE, KC.LCTRL, xxxxx, xxxxx, KC.N5, xxxxx, KC.MINUS, KC.F9, # map GRAVE to <a-äöüppppppppppp¨¨
    # x12
    ...
    xxxxx, KC.SPC, xxxxx, xxxxx, KC.UP, xxxxx, KC.F6, KC.H, KC.F4, # 74 is fn --> not sure how to map this
